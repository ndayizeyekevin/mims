...
<header class="bg-dark text-white py-3">
    <div class="container d-flex align-items-center">
        ...
        <h4 class="ms-3">Users Management</h4>
    </div>
</header>
                        ...
                        <form id="editUserForm" method="POST" action="edit_user.php">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="username" class="form-control bg-light" id="editUsername" readonly required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="role" class="form-control bg-light" id="editRole" readonly required>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
